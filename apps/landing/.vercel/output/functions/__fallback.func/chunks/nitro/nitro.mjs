...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","base":"/","dir":"./public","root":"/home/node/.openclaw/workspace/cog-labs/apps/landing","order":0,"outDir":"/home/node/.openclaw/workspace/cog-labs/apps/landing/.vinxi/build/public"},{"name":"ssr","type":"http","link":{"client":"client"},"handler":"src/entry-server.tsx","extensions":["js","jsx","ts","tsx"],"target":"server","root":"/home/node/.openclaw/workspace/cog-labs/apps/landing","base":"/","outDir":"/home/node/.openclaw/workspace/cog-labs/apps/landing/.vinxi/build/ssr","order":1},{"name":"client","type":"client","base":"/_build","handler":"src/entry-client.tsx","extensions":["js","jsx","ts","tsx"],"target":"browser","root":"/home/node/.openclaw/workspace/cog-labs/apps/landing","outDir":"/home/node/.openclaw/workspace/cog-labs/apps/landing/.vinxi/build/client","order":2},{"name":"server-fns","type":"http","base":"/_server","handler":"../../node_modules/.pnpm/@solidjs+start@1.3.2_solid-js@1.9.12_vinxi@0.5.11_@types+node@22.19.18_db0@0.3.4_ioredi_8246f176776f56f15fbefc860d18a03d/node_modules/@solidjs/start/dist/runtime/server-handler.js","target":"server","root":"/home/node/.openclaw/workspace/cog-labs/apps/landing","outDir":"/home/node/.openclaw/workspace/cog-labs/apps/landing/.vinxi/build/server-fns","order":3}],"server":{"compressPublicAssets":{"brotli":true},"routeRules":{"/_build/assets/**":{"headers":{"cache-control":"public, immutable, max-age=31536000"}}},"experimental":{"asyncContext":true},"preset":"vercel","prerender":{}},"root":"/home/node/.openclaw/workspace/cog-labs/apps/landing"};
					const buildManifest = {"ssr":{"_store-Dyfw-H4F.js":{"file":"assets/store-Dyfw-H4F.js","name":"store"},"src/routes/api/contact.ts?pick=GET":{"file":"contact.js","name":"contact","src":"src/routes/api/contact.ts?pick=GET","isEntry":true,"isDynamicEntry":true,"imports":["_store-Dyfw-H4F.js"]},"src/routes/api/contact.ts?pick=POST":{"file":"contact2.js","name":"contact","src":"src/routes/api/contact.ts?pick=POST","isEntry":true,"isDynamicEntry":true,"imports":["_store-Dyfw-H4F.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"dynamicImports":["src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=POST","src/routes/api/contact.ts?pick=POST"]}},"client":{"_web-Cj2XmDbK.js":{"file":"assets/web-Cj2XmDbK.js","name":"web"},"src/routes/admin.tsx?pick=default&pick=$css":{"file":"assets/admin-DC0GtQVy.js","name":"admin","src":"src/routes/admin.tsx?pick=default&pick=$css","isEntry":true,"isDynamicEntry":true,"imports":["_web-Cj2XmDbK.js"]},"src/routes/index.tsx?pick=default&pick=$css":{"file":"assets/index-Cp40xNnH.js","name":"index","src":"src/routes/index.tsx?pick=default&pick=$css","isEntry":true,"isDynamicEntry":true,"imports":["_web-Cj2XmDbK.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-DkHKGmcU.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_web-Cj2XmDbK.js"],"dynamicImports":["src/routes/admin.tsx?pick=default&pick=$css","src/routes/index.tsx?pick=default&pick=$css"],"css":["assets/client-CKcG6QHv.css"]}},"server-fns":{"_server-fns-CBEkPcnd.js":{"file":"assets/server-fns-CBEkPcnd.js","name":"server-fns","dynamicImports":["src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=GET","src/routes/api/contact.ts?pick=POST","src/routes/api/contact.ts?pick=POST","src/app.tsx"]},"_store-Dyfw-H4F.js":{"file":"assets/store-Dyfw-H4F.js","name":"store"},"src/app.tsx":{"file":"assets/app-DuHjFU5s.js","name":"app","src":"src/app.tsx","isDynamicEntry":true,"imports":["_server-fns-CBEkPcnd.js"],"css":["assets/app-CKcG6QHv.css"]},"src/routes/api/contact.ts?pick=GET":{"file":"contact.js","name":"contact","src":"src/routes/api/contact.ts?pick=GET","isEntry":true,"isDynamicEntry":true,"imports":["_store-Dyfw-H4F.js"]},"src/routes/api/contact.ts?pick=POST":{"file":"contact2.js","name":"contact","src":"src/routes/api/contact.ts?pick=POST","isEntry":true,"isDynamicEntry":true,"imports":["_store-Dyfw-H4F.js"]},"virtual:$vinxi/handler/server-fns":{"file":"server-fns.js","name":"server-fns","src":"virtual:$vinxi/handler/server-fns","isEntry":true,"imports":["_server-fns-CBEkPcnd.js"]}}};
...
async function dt(e, t) {
  ...
  return a.request = new Request(n, { headers: Zo(e) }), await provideRequestEvent(a, async () => {
    await In(a), ve$1 || (ve$1 = (await import('../build/app-DuHjFU5s.mjs')).default), a.router.dataOnly = r || true, a.router.previousUrl = e.request.headers.get("referer");
    try {
      renderToString(() => {
